...
$res=mysqli_query($conn,"SELECT att_id,start_date,end,course_id,sem_id from attend_master where declard='Yes' and course_id=1;");
...
{?>
			...
			$res1=mysqli_query($conn,$qry1) or die();
			$tot=0;
			$obtot=0;
			$avg=0;
			while($row=mysqli_fetch_array($res))
