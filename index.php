...
<link rel="shortcut icon" href="css/images/logo 1.png" />
...
<H6 style="margin-top:-18px;margin-left:900px;font-size:15px;color:#ffffff;" ><a href="admin/login.php">Login</a></h6>
...
<img src="css/images/6.jpg" width="1000" height="525" alt="Slide Image" />
...
<br>				
<img src="admin/image/5.jpg" alt="Post Image" width="135" height="159"/>
...
$res10 = mysqli_query($con, "select info from collegeinfo_master where info_type='diretor msg';");
...
<div style="margin-top:-50px;margin-left:630px;width: 253px;
	float: left;
	margin-left: ;">	
<h6 style="font-family: Arial, Helvetica, sans-serif;
    font-size: 18px;
...
Surat - 395 005</b>
			...
			<br>
                    <div  class="box_us">
                          ...
                          <div  class="box_us_r">
                                <b class="lh" >E-mail: srm@indiatimes.com</b>
                          </div>
                          <div style="clear: both; height:10px;"></div>
                    </div>
           		</div>
