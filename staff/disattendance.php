...
<?php
$res=mysql_query("select * from sub_taken_master where fac_id=$fid;");
...
while($cnt>0)
{
	while($row=mysql_fetch_array($res))
	{
		...
		$res1=mysql_query("SELECT * from attend_master where declard='Yes' and sem_id=$sid and course_id=$cid;");
