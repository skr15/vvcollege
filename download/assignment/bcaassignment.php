...
<br>					
<center><h2 style="margin-left:12px;margin-top:;font-size:20px;px;">The Following link of BCA Assignment</h2>
...
$res=mysqli_query($conn,"SELECT * from download_master where course_id=1 and down_type='assignment';");
