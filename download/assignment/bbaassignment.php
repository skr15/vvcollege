...
<br>					
<center><h2 style="margin-left:12px;margin-top:;font-size:20px;px;">The Following link of BBA Assignment</h2>
...
$res=mysql_query($conn,"SELECT * from download_master where course_id=2 and down_type='assignment';");
