...
<br>					
<center><h2 style="margin-left:12px;margin-top:;font-size:20px;px;">The Following link of BED Syllabus</h2>
...
$res=mysql_query("SELECT * from download_master where course_id=5 and down_type='syllabus';");
