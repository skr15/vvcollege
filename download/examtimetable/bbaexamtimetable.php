...
<li><a href="#" title="Drop down menu 2">BBA</a></li>
...
<br>					
<center><h2 style="margin-left:12px;margin-top:;font-size:20px;px;">The Following link of BBA exam time table</h2>
...
$res=mysqli_query($conn,"SELECT * from download_master where course_id=2 and down_type='timetable';");
