...
<li class="active"><a href="#" title="Football">Download</a>
...
<li><a href="bcaexamtimetable.php" title="Dr">BCA</a></li>
											
<li><a href="bbaexamtimetable.php" title="Drop down menu 2">BBA</a></li>
											
<li><a href="bcomexamtimetable.php" title="Drop down menu 3">BCOM</a></li>
											
<li><a href="bedexamtimetable.php" title="Drop down menu 4">BED</a></li>

<li><a href="ptcexamtimetable.php" title="Drop down menu 4">PTC</a></li>
...
<br>					
<center><h2 style="margin-left:12px;margin-top:;font-size:20px;px;">The Following link of BCOM exam time table</h2>
...
$res=mysqli_query($conn,"SELECT * from download_master where course_id=3 and down_type='timetable';");
...
<a href="<?php echo $path?>"><?php echo $row['down_title']?></a>
</li>
<?php
}?>
</ul>	
