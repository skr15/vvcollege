...
<H6 style="margin-top:40px;margin-left:75px;font-size:32px;color:#666666;font-weight:bold" >SRM COLLEGE FOR BCA,BBA,B.COM,B.Ed,PTC </h6>
	...
	<div id="login-inner">
		...
		<tr>
			<th>Usertype</th>
			<td>
			<select name="usertype"  style="margin-left:px;background-color:#000000;width:220px;height:35px;"  size="1" class="login-inp">
		<?php 
		...
		$res=mysqli_query($con,"select user_type from user_master;");
...
echo "Message has been sent....!";
	...
	if(isset($_POST['s1']))
	{
		...
		$res=mysqli_query($con1,"select user_type_id from user_master where user_type='$type';");
		$row=mysqli_fetch_array($res);
		$id=$row['user_type_id'];
		$qry="select * from login_master where user_type_id=$id;";
		$res1=mysqli_query($con1,$qry);
