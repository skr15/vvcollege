...
<title>Vivekanand College BBA Faculty List</title>
...
<h1  style="font-family: Verdana, Helvetica, sans-serif;font-size:25px;color:#3CB371;">BBA Faculty</h1><br>
				
					<?php
						$conn=mysqli_connect("eu-cdbr-west-03.cleardb.net","bef02abf1996f3","01233466");
		mysqli_select_db($conn,"heroku_d61df1c5316c5a5");
						$res=mysqli_query($conn,"SELECT * from faculty_master where course_id=2;");
