...
<title>Vivekanand College BCA Faculty List</title>
...
<h1  style="font-family: Verdana, Helvetica, sans-serif;font-size:25px;color:#3CB371;">BCA Faculty</h1><br>
				
					<?php
						$conn=mysqli_connect("eu-cdbr-west-03.cleardb.net","bef02abf1996f3","01233466");
		mysqli_select_db($conn,"heroku_d61df1c5316c5a5");
						$res=mysqli_query($conn,"SELECT * from faculty_master where course_id=1;");
						...
						{?>
							...
							<table style="margin-left:;margin-right:auto;font-family: Verdana, Helvetica, sans-serif;font-size:18px;">
							<tr><h2 style="border-bottom: 1px solid #000000;"></h2>
							<th style="margin-left:px;color:#CD5C5C;text-align:left">
							Name &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							</th>
							<td style="font-family: Verdana, Helvetica, sans-serif;font-size:17px;color:#00BFFF"><?php echo $name?>
							</td>
							
							<td rowspan="4">
							<img src="<?php echo $path1?>"height="160" width="150" style="margin-right:-300px;margin-left:px;"  align="right" class="rshape">
							</td>
							</tr>
							...
							<tr>
							<td align="center"><a href="viewdetails.php?facid=<?php echo $id;?>">More Details</a></td>		
							</tr>
